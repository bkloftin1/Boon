...
$requests = getAllRequests($db, $_SESSION['UserID']);
ob_end_clean();
...
<body>
    <div class="header">
	  <div class="logo">
			<a href="Fullfillment.php"><img src="logo.png" alt="Boon Logo"></a>
		</div>
		<div class="button">
			<a href="ongoing2.php">On going</a>
  ...
  <h2>Service Request</h2> <!--Change the stlye in h2 css-->
        ...
        <?php foreach ($requests as $request): ?>
            <li class="card">
                ...
                <div class="card-content">
                  <h5><?php echo "Phone Number: ", $request['PhoneNumber']; ?></h5>
                  ...
                  <h5><?php echo "Details: ", $request['DetailsofService']; ?></h5>
                </div>
                </div>
                <div class="card-link-wrapper">
                <form method="post" action="acceptance.php">
                  <input type="hidden" name="request_id" value=<?php echo $request['RequestID'] ;?> >
                  <button type="submit" name="approve" value="Accepted" class="card-link">Accept</button>
                  <button type="submit" name="approve" value="Rejected" class="card-link">Reject</button>
                  </form>
