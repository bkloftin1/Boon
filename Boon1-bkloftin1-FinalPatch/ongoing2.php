...
include("config.php");
session_start();
include("acceptanceRequest.php");
$requests = getAllAcceptedRequests($db, $_SESSION['UserID']);
ob_end_clean();
  ...
  <div class="header">
    ...
    <div class="container">
      ...
      <?php foreach ($requests as $request): ?>
        <li class="card">
        <div>
                    <h3 class="card-title"><?php echo $request['FirstName'] , " " , $request['LastName']; ?></h3>
                    <div class="card-content">
                        <h4><?php echo $request['ServiceType'];?></h4>
                        <h5><?php echo "Phone Number: ", $request['PhoneNumber'];?></h4>
            ...
            <button type="submit" name="approve" value="Cancelled by Provider" class="card-link">Cancel</button>
            </form>
        </li>
      <?php endforeach; ?>
            </div>
